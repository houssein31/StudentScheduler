...
//        Toast.makeText(this, String.valueOf(termID), Toast.LENGTH_SHORT).show();
    ...
    private void saveNewTerm(String termTitle, String termStartDate, String termEndDate) {
        ...
        Term term = new Term(username, termTitle, termStartDate, termEndDate);


        termDAO.insertTerm(term);
//        finish();
        launchDisplayTermPageActivity();
        super.finish();
    }
    ...
    private void launchDisplayTermPageActivity() {
        Intent i = new Intent(this, DisplayTerm.class);
